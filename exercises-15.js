function groupAnimals(animals) {
    ...
    for (let i = 0; i < animals.length; i++) {
        ...
        // jika ada = ambil index array huruf itu (huruf.indexOf(huruf_pada_hewan))
        // jika belum ada = push huruf itu ke array huruf (push_huruf = huruf.push(huruf_pada_hewan))
        //                  dan ambil indexnya (index = push_huruf-1)
        ...
        // jika belum terisi = push hasil dengan nama hewan (nama_hewan = animals[i]) dalam bentuk array (hasil.push([nama_hewan]))
        // jika sudah terisi = push array dalam array hasil dengan nama hewan (hasil[index].push(nama_hewan))
